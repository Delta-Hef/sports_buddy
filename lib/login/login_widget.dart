                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (role == 'superadmin') {
                              context.goNamedAuth(AdminWidget.routeName, context.mounted);
                            } else if (role == 'bookingadmin') {
                              context.goNamedAuth(AdminManageSlotsWidget.routeName, context.mounted); // your booking control screen
                            }else if (role == 'admin'){
                              context.goNamedAuth(AdminWidget.routeName, context.mounted);
                            }
                            else {
