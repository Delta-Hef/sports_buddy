...
import 'football_room_options_model.dart';
export 'football_room_options_model.dart';
...
class FootballRoomOptionsWidget extends StatefulWidget {
  const FootballRoomOptionsWidget({super.key});

  static String routeName = 'Football_room_options';
  static String routePath = '/footballRoomOptions';

  @override
  State<FootballRoomOptionsWidget> createState() =>
      _FootballRoomOptionsWidgetState();
}

class _FootballRoomOptionsWidgetState extends State<FootballRoomOptionsWidget> {
  late FootballRoomOptionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FootballRoomOptionsModel());
  }
                    ...
                    children: [
                      Container(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed(CreateFootballWidget.routeName);
                          },
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      Container(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed(JoinRoomWidget.routeName);
                          },
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            mainAxisAlignment: MainAxisAlignment.center,
