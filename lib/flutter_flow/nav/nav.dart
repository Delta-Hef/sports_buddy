...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: TennisRoomOptionsWidget.routeName,
          path: TennisRoomOptionsWidget.routePath,
          builder: (context, params) => TennisRoomOptionsWidget(),
        ),
        FFRoute(
          name: FootballRoomOptionsWidget.routeName,
          path: FootballRoomOptionsWidget.routePath,
          builder: (context, params) => FootballRoomOptionsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AcademiesWidget.routeName,
          path: AcademiesWidget.routePath,
          builder: (context, params) => NavBarPage(initialPage: 'Academies'),
        ),


        FFRoute(
          name: JoinRoomWidget.routeName,
          path: JoinRoomWidget.routePath,
          builder: (context, params) => JoinRoomWidget(),
        ),
        FFRoute(
          name: JoinTennisRoomWidget.routeName,
        ...
        FFRoute(
          ...
          builder: (context, params) => RequestSentWidget(),
        ),
        FFRoute(
          name: CreateFootballWidget.routeName,
          path: CreateFootballWidget.routePath,
          builder: (context, params) => CreateFootballWidget(),
        ),
        FFRoute(
          name: CreateTennisWidget.routeName,
          path: CreateTennisWidget.routePath,
          builder: (context, params) => CreateTennisWidget(),
        ),
        // FFRoute(
        //   name: CreateRoomDetailsWidget.routeName,
        //   path: CreateRoomDetailsWidget.routePath,
        //   builder: (context, params) => CreateRoomDetailsWidget(),
        // ),
        // FFRoute(
        //   name: CreateRoomDetailsCopyWidget.routeName,
        ...
        FFRoute(
          name: AdminManageSlotsWidget.routeName,
          path: AdminManageSlotsWidget.routePath,
          builder: (context, params) => AdminManageSlotsWidget(),
        )
