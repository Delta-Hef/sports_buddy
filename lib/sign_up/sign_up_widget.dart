                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: 'Enter your favorite sport',
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                        font: GoogleFonts.inter(
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: '1 Word to describe yourself',
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                        font: GoogleFonts.inter(
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await FirebaseFirestore.instance.collection('users').doc(user.uid).set({
                                    ...
                                    'age': _model.textController2.text.trim(),
                                    'favoriteSport': _model.textController3.text.trim(),
                                    'description': _model.textController4.text.trim(),
                                    'email': user.email,
